...
object AppConfig {
    ...
    val TAG: String get() = hostPackageName
    ...
    /** Broadcast actions. */
    val BROADCAST_ACTION_SERVICE: String get() = "${ANG_PACKAGE}.action.service"
    val BROADCAST_ACTION_ACTIVITY: String get() = "${ANG_PACKAGE}.action.activity"
    val BROADCAST_ACTION_WIDGET_CLICK: String get() = "${ANG_PACKAGE}.action.widget.click"
